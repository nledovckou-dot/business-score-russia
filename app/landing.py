"""Landing page HTML — white minimalist theme, all 14 pipeline steps."""
...
<title>Анализ бизнеса</title>
<style>
:root{--bg:#fff;--card:#f8f8f8;--border:#e8e8e8;--text:#111;--text2:#555;--text3:#999;--accent:#111;--green:#22c55e;--red:#ef4444;--orange:#eab308}
*{box-sizing:border-box;margin:0;padding:0}
body{background:var(--bg);color:var(--text);font-family:-apple-system,system-ui,'Segoe UI',sans-serif;min-height:100vh;display:flex;flex-direction:column;align-items:center;padding:0 20px}
.wrap{max-width:640px;width:100%}

#phase-url{text-align:center;margin-top:16vh}
h1{font-weight:300;font-size:1.8em;margin-bottom:8px;letter-spacing:-0.02em}
...
.btn{padding:14px 28px;background:var(--accent);border:none;border-radius:10px;color:#fff;font-size:0.95em;font-weight:600;cursor:pointer;font-family:inherit;white-space:nowrap;transition:opacity 0.2s}
...
.pipeline-header h2{font-size:1.1em;font-weight:500;margin-bottom:4px}
.pipeline-header .url-tag{color:var(--text3);font-size:0.82em}
.steps{border:1px solid var(--border);border-radius:12px;margin-bottom:16px;overflow:hidden}
...
.step-group{padding:6px 18px 4px;font-size:0.72em;font-weight:600;color:var(--text3);text-transform:uppercase;letter-spacing:0.06em;background:var(--card);border-bottom:1px solid var(--border)}

.panel{border:1px solid var(--border);border-radius:12px;padding:20px;margin-bottom:16px;display:none}
.panel h3{font-size:0.95em;font-weight:600;margin-bottom:14px}
...
.field input,.field select{width:100%;padding:10px 12px;border:1px solid var(--border);border-radius:8px;color:var(--text);font-size:0.9em;font-family:inherit;background:var(--bg)}
...
.comp-item{display:flex;align-items:center;gap:12px;border:1px solid var(--border);border-radius:8px;padding:12px 14px}
...
.comp-name{font-weight:600;font-size:0.9em;margin-bottom:1px}
...
.result{display:none;text-align:center;padding:32px 24px;border:1px solid var(--border);border-radius:12px}
.result h3{font-weight:500;font-size:1.15em;margin-bottom:4px}
.result .company{color:var(--text2);font-size:0.85em;margin-bottom:16px}
.result a{display:inline-block;padding:12px 36px;background:var(--accent);color:#fff;font-weight:600;font-size:0.95em;border-radius:10px;text-decoration:none;transition:opacity 0.2s}
...
.auth-bar{position:fixed;top:0;right:0;left:0;display:flex;justify-content:flex-end;align-items:center;gap:8px;padding:8px 20px;z-index:100;background:rgba(255,255,255,0.92);backdrop-filter:blur(10px);border-bottom:1px solid var(--border)}
...
.auth-bar .quota-badge{padding:2px 8px;border-radius:10px;font-size:0.75em;font-weight:600;background:var(--card);color:var(--text2);border:1px solid var(--border)}
.auth-bar .quota-badge.depleted{background:#fef2f2;color:var(--red);border-color:#fecaca}
...
.btn-auth-login:hover{border-color:var(--accent) !important;color:var(--accent)}
.btn-auth-register{background:var(--accent);color:#fff;font-weight:600}
...
.modal h2{font-size:1.1em;font-weight:600;margin-bottom:4px}
...
.modal .modal-close:hover{color:var(--text);background:var(--card)}
...
.modal .btn-full{width:100%;padding:11px;background:var(--accent);border:none;border-radius:8px;color:#fff;font-size:0.9em;font-weight:600;cursor:pointer;font-family:inherit}
.modal .btn-full:hover{opacity:0.85}
...
<div class="wrap" style="padding-top:52px">
    <div id="phase-url">
        <h1>Анализ бизнеса</h1>
        <p class="sub">Вставьте ссылку на сайт компании — получите полный отчёт с финансами, конкурентами и стратегией</p>
        <div class="input-row">
