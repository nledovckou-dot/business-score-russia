...
- ЗАПРЕЩЕНО использовать размытые слова в метриках: "мало", "много", "есть", "несколько", "достаточно", "примерно", "~"
- Каждое значение — конкретное число. Нет данных = null, НЕ "мало" или "—"
- Пример: НЕ "500+ SKU" → "523 SKU" или null если не знаешь точно"""
...
4. Цитаты ТОЛЬКО от реальных людей с РЕАЛЬНЫМИ source_url (ссылки на статьи в СМИ: РБК, Forbes, Коммерсант, Ведомости, VC.ru, Собака.ru и т.д.)
5. Если source_url неизвестен — НЕ включай эту цитату. Лучше 2 реальные цитаты, чем 5 выдуманных
6. ЗАПРЕЩЕНО: выдумывать URL, ставить example.com, использовать несуществующие статьи
7. Если не знаешь ни одной реальной цитаты — верни пустой массив opinions: []"""
